<%-- 
    Document   : execfunct1
    Created on : Aug 01, 2019, 04:12:00 PM
    Author     : floriano
--%>
...
<html lang="it">
    <head>        
        ...
        <title>Funzioni esecutive: controllo-inibizione</title>
        ...
        <div class="container">
            ...
            <!--div class="navbar" style="background-color:white"-->
                <div class="well well-sm">
                    <h3 align="center">Cataloga gli oggetti (${exdescr})</h3>
                    <hr></hr>                    
                    <div class="row">
                        <div class="col-sm-8">
                            <button id="tryexercise" class="btn btn-lg btn-warning pull-right"
                                        onclick="
                                            post('createexecfunct1', {
                                                difficulty: 'training',
                                                patientid: '${patientid}',
