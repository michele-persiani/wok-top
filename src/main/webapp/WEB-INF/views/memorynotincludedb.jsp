...
<html lang="it">
    ...
    <body>
        <div class="container">
            <div class="navbar navbar-fixed-top" style="background-color:white">
                <div class="well well-sm">
                    <div class="row">
                        <div class="col-sm-12">
                            <h4 class="pull-right">Le figure sotto sono le stesse che hai visto prima?</h4>
                        </div>
                        <div class="col-sm-3">
                            <input type="button" class="btn btn-primary pull-right" value="Si'" onclick="calculateResult(true)">
                        </div>
                        <div class="col-sm-3">
                            <input type="button" class="btn btn-primary pull-right" value="No" onclick="calculateResult(false)">
                        </div>
                        <div class="col-sm-6">
        ...
        <script>
                            ...
                            function calculateResult(flag) {
                                passed = ((flag && ${same}) || (!flag && !${same}));
                                window.alert('Passato:\t\t\t' + passed);

                                // Calculate performance and decide if the exercise passed
                                // Or pass all to server and calculated there performance and
                                // passed
                               post('memory1phase3',
                                        {
