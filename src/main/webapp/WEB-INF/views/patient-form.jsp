<%-- 
    Document   : patient-form
    Created on : Feb 17, 2016, 2:09:34 PM
    Author     : floriano
--%>
...
<html lang="it">
    <head>
        ...
        <title>Dati <!--paziente-->partecipante</title>
    ...
    <body>
        <div class="container">
            ...
            <div class="jumbotron">
                <h2><!--paziente-->partecipante</h2>                      
                <spring:url value="/saveorupdatepatient" var="userActionUrl" />                
                <spring:url value="/files/photos/" var="photosPath" />

                <form:form class="form-horizontal" method="post" modelAttribute="patientForm" action="${userActionUrl}" enctype="multipart/form-data">
                    ...
                    <spring:bind path="surname">
                        <div class="form-group ${status.error ? 'has-error' : ''}">
                            ...
                            <div class="col-sm-20">
                                <form:input path="surname" type="text" class="form-control " id="surname" placeholder="Cognome" />
                    ...
                    <spring:bind path="phone">
                        <div class="form-group ${status.error ? 'has-error' : ''}">
                            ...
                            <div class="col-sm-20">
                                <form:input path="phone" rows="5" class="form-control" id="phone" placeholder="Telefono" />
                    ...
                    <spring:bind path="photo">
                        <div class="form-group ${status.error ? 'has-error' : ''}">
                            ...
                            <div class="col-sm-4">
                                <c:if test="${status.value!='' && status.value!=null}">
                                    <img src="${photosPath}${status.value}" class="img-circle img-responsive" alt="photo">
                                </c:if>
                                <c:if test="${status.value=='' || status.value==null}">
                                    <img src="resources/images/photos/default-portrait.png" class="img-circle img-responsive" alt="photo">
                                </c:if>                                    
                            </div>
                            
                            <div class="col-sm-16">
                                <input type="file" name="photofile" class="filestyle"
                                            data-input="false"
                                            data-buttonText="Cambia foto"
                                            data-size="sm"
                                            data-placeholder="Nessuna foto"
        ...
        <jsp:include page="modal-pat-form.jsp"/>
