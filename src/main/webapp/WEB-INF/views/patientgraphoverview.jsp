<%-- 
    Document   : patientgraphoverview
    Created on : 17-nov-2016, 10.41.56
    Author     : danger
--%>
...
<html>
    <head>
        ...
        <script>
            ...
            function loadSection(){
                $('a[difficulty="${difficulty}"').removeClass("btn-default");
                $('a[difficulty="${difficulty}"').addClass("btn-primary");
            }
            ...
            $(document).ready(function(){
                ...
                function drawBar(element,json,num){
                    var succandfailbar = c3.generate({
                        bindto: element,
                        data:json,
                        bar:{
                          width:{
                ...
                function loadSuccAndFail(group,element,start,end){
                    $("#infomessage").hide();
                    $.get("patientsuccandfailjson",
                        {
                            "patientid":${patient.id},
                            "start":start,
                            "end":end,
                ...
                function loadAll(group){
                    ...
                    loadOverview(group,"#graphchart1",start,end);
                    loadSuccAndFail(group,"#graphchart2",start,end);
                ...
                drawGraph("#graphchart1",${json_graph});
                drawBar("#graphchart2",${json_bar});
    ...
    <body>
                ...
                <nav>
                    <ul class="nav nav-pills pull-right">
                        <li role="presentation">
                            <a id="backbutton" href="patientchosegraph?patientid=${patient.id}">                                
        ...
        <jsp:include page="modal-pat-graph-ovw.jsp"/>        
