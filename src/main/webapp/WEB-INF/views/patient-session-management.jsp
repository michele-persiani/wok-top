<%-- 
    Document   : patient-session-management
    Created on : Jul 4, 2017, 10:10:34 AM
    Author     : floriano
--%>
...
<html lang="it">
    <head> 
        ...
        <title>Sessioni esercizi <!--pazienti-->partecipanti</title>
    ...
    <body>
        <div class="container">
            ...
            <div class="jumbotron">
                ...
                <p class="lead"><strong>Esercizi per <!--pazienti-->partecipanti</strong></p>
                ...
                <p class="lead">
                    <c:if test="${newsession=='false'}">
                        <a class="btn btn-lg btn-success disabled"
                           ...
                           data-toggle="tooltip" data-placement="bottom" title="Non ci sono pazienti a cui si possono configurare sessioni"
                           role="button">
                            Configura sessione
                        </a>
                    </c:if>
                    <c:if test="${newsession=='true'}">
                        <a class="btn btn-lg btn-success"
                           href="patientsession" role="button">
                            Configura sessione
                        </a>
                    </c:if>
                </p>
                        ...
                        <table class="table table-striped">
                            ...
                            <c:forEach var="session" items="${hospitalsessions}" varStatus="status">
                                <tr class="active">
                                    ...
                                    <td>${hospitalpatientnames[status.index]}</td>
                        ...
                        <table class="table table-striped">
                            ...
                            <c:forEach var="session" items="${homesessions}" varStatus="status">
                                <tr>
                                    ...
                                    <td>${homepatientnames[status.index]}</td>
        ...
        <jsp:include page="modal-pat-sess-man.jsp"/>
