<%-- 
    Document   : patient-training
    Created on : Feb 16, 2017, 6:35:34 PM
    Author     : floriano
--%>
...
<body>
	<div class="container">
		...
		<div class="jumbotron">
			<h2>Ecco i suoi esercizi di prova</h2>
			<p></p>
							...
							<ul class="list-group" style="position: relative;">
								...
								<div class="collapse" id="${category.id}"
									...
									<c:forEach var="exercise" items="${category.exercises}">
										...
										<c:choose>
											<c:when
													test="${category.id == 'ATT_RFLXS'}">
												<c:url var="exerciseURL" value="createreflexes1">
