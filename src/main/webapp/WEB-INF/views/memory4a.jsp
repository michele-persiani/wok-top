<%-- 
    Document   : memory4a
    Created on : Mar 20, 2017, 1:07:00 PM
    Author     : floriano
--%>
    ...
    <body>
        <div class="container">
            ...
            <div class="well well-sm">
                <div class="row">
                    <div class="col-sm-15">
                        <h3 class="pull-left">Memorizzi i nomi delle persone che appariranno.</h3>
                        <h3 class="pull-left">Clicchi sul pulsante continua. Scriva i nomi corretti sotto i volti che vedr&agrave;.</h3>
                        <h3 class="pull-left">Durante il compito potrebbe capitare di trovare gli stessi volti con nome e cognome differenti o lo stesso nome e cognome con volti differenti, ricordarsi di fare riferimento sempre all’ultimo volto presentato.<h3>
                    </div>
                    <c:if test="${difficulty=='training' || difficulty=='demo'}">
            ...
            <jsp:include page="modal-mem4.jsp" />
