    ...
    <body onkeypress="fun(event)">
        <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                          ...
                          <!--  <c:if test="${type=='ATT_ALT_FAC'}">
                                <h3 class="pull-left">Clicchi o prema il pulsante spazio su questo volto.</h3>
                            </c:if>
                            ...
                            <c:if test="${type=='ATT_ALT'}">
                                <h3 class="pull-left">Clicchi o prema il tasto spazio su questa figura.</h3>
                            </c:if>-->
                        </div>
                        ...
                        <div class="col-sm-5">
                           ...
                           <!-- <c:if test="${type=='ATT_ALT_FAC'}">
                                <h3 class="pull-right">Quando sentir&agrave; il suono inizi a cliccare o a premere il pulsante spazio su quest'altro volto.</h3>
                            </c:if>
                            <c:if test="${type=='ATT_ALT_ORI'}">
                                <c:if test="${exname=='ATT_ALT_ARR'}">
                                    <h3 class="pull-right">Quando sentir&agrave; il suono inizi a cliccare o a premere il pulsante spazio su quest'altra freccia.</h3>
                                </c:if>
                                <c:if test="${exname=='ATT_ALT_CMP'}">
                                    <h3 class="pull-right">Quando sentir&agrave; il suono  inizi a cliccare o a premere il pulsante spazio sulla freccia che indica quest'altra direzione.</h3>
                                </c:if>
                            </c:if>
                            <c:if test="${type=='ATT_ALT'}">
                                <h3 class="pull-right">Quando sentir&agrave; il suono inizi a cliccare o a premere il pulsante spazio su quest'altra figura.</h3>
                            </c:if>      -->                      
                        </div>
                        ...
                        <div class="col-sm-8"> <h3 class="pull-left" id="im3"></h3>
                            <!--
                            <c:if test="${type=='ATT_ALT_FAC'}">
                                <h3 class="pull-left">Se sentir&agrave; di nuovo il suono, dovr&agrave; tornare a cliccare sul volto precedente.<br>Alterni i due volti.</h3>
                            </c:if>
                            <c:if test="${type=='ATT_ALT_ORI'}">
                                <c:if test="${exname=='ATT_ALT_ARR'}">
                                    <h3 class="pull-left">Se sentir&agrave; di nuovo il suono, dovr&agrave; tornare a cliccare sulla freccia precedente.<br>Alterni le due frecce.</h3>
                                </c:if>
                                <c:if test="${exname=='ATT_ALT_CMP'}">
                                    <h3 class="pull-left">Se sentir&agrave; di nuovo il suono, dovr&agrave; tornare a cliccare sulla freccia che indica la direzione precedente.<br>Alterni le due direzioni.</h3>
                                </c:if>
                            </c:if>
                            <c:if test="${type=='ATT_ALT'}">
                                <h3 class="pull-left">Se sentir&agrave; di nuovo il suono, dovr&agrave; tornare a cliccare sulla figura precedente.<br>Alterni le due figure.</h3>
                            </c:if>    -->                        
                        </div>
                    </div>
            ...
            <script>
                ...
                audio07.load();
                //var audio = new Audio('resources/audio/multiaudio-03.mp3');
                //var spriteData = {
                //    s1: {
                //        start: 0,
                //        length: 0.5
                ...
                $("#myCarousel").on('slide.bs.carousel', function () {
                 ...
                 $("#myCarousel").on('slid.bs.carousel', function () {
                    ...
                    if (currentIndex === $('.item').length) {
                        //setTimeout(nextTarget, ${time} * 400);
                ...
                async function nextTarget(sld) {
                    ...
                    //setTimeout(calculateResult, 400);
                    calculateResult();
                }
                ...
                function calculateResult() {
                    ...
                    nCorrect = ${pCorrect}+nCorrect;
                    nMissed = ${pMissed}+nMissed;
                    nWrong = ${pWrong}+nWrong;
                    dTime = ${pTime}+dTime;
                    ...
                    if (${leftiterations} == 0) {
                        ...
                        post('attention3phase2', {
                            ...
                            targetelement1img: '${targetelement1img}',
                            targetelement2img: '${targetelement2img}',
