<%-- 
    Document   : npsprofile-form
    Created on : Mar 8, 2017, 12:37:34 PM
    Author     : floriano
--%>
...
<html lang="it">
    ...
    <body>
        <div class="container">
            ...
            <div class="jumbotron">
                <h2>Profilo neuropsicologico di ${patientname}</h2>
                
                <ul class="nav nav-tabs">
                    <li><a href="npstestsel?patientid=${patientid}"><h4>NPS test</h4></a></li>
                    <li><a href="raotestsel?patientid=${patientid}"><h4>Rao test</h4></a></li>
                    <li><a href="whitetestsel?patientid=${patientid}"><h4>White test</h4></a></li>
                </ul>
            </div>
        ...
        <jsp:include page="modal-npsprof-form.jsp"/>
