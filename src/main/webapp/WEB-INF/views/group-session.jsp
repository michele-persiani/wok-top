<%-- 
    Document   : group-session
    Created on : Dec 19, 2016, 9:49:34 AM
    Author     : floriano
--%>
...
<html lang="it">
    ...
    <body>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <spring:bind path="MEM_VIS_2">
                                <div class="form-group">
                                    <label>Memoria visuo-spaziale</label>
                        ...
                        <div class="col-sm-6">
                            <spring:bind path="MEM_VIS_5">
                                <div class="form-group">
                                    <label>Memoria visuo-spaziale griglia</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <spring:bind path="MEM_LONG_1">
                                <div class="form-group">
                                    <label>Associazione volti-nomi</label>
        ...
        <jsp:include page="modal-grp-sess.jsp" />
