<%-- 
    Document   : modal-pat-live
    Created on : May 2, 2017, 3:58:48 PM
    Author     : floriano
--%>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h4>Qui puoi vedere in tempo reale come un <!--paziente-->partecipante sta svolgendo gli esercizi.</h4>
                <h4>In ciascuna riga trovi il nome dell'esercizio, l'attuale livello di difficolt&agrave;, l'ultima performance, e l'ultimo orario in cui il <!--paziente-->partecipante ha eseguito l'esercizio.</h4>
