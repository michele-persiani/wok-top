    ...
    <body onkeypress="fun(event)">
        <div class="container">
            ...
            <script>
                ...
                var targetattivo=${targetelement1};
                ...
                $("#myCarousel").on('slide.bs.carousel', function () {
                    ...
                    if(exElement.id==("i"+(${nelementspertarget-1}*(nIteration-1)))&&nIteration!=0){
                    
                        console.log("dentro if"+ exElement.id);
                        audio07.play();
                        if(contaScambiaTarget%2==0){
                            targetattivo=${targetelement2};
                            targetId=${noTarget.id};
